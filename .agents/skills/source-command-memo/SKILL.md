---
name: "source-command-memo"
description: "指定した本の notes/{KEY}.md にメモを追記/編集。引数なしなら追記対象を選ばせる"
---

# source-command-memo

Use this skill when the user asks to run the migrated source command `memo`.
...
- Codex in Chrome で `http://localhost:8765/book.html?id={KEY}` を navigate
- メモ欄に追記内容が反映されているか確認
